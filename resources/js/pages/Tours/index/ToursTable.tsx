        ...
        <Table containerClassName="relative max-h-[600px] overflow-auto" className="border-collapse rounded-md border border-border">
            <TableHeader style={{ position: 'sticky', top: 0, zIndex: 20 }}>
                <TableRow className="border-border">
                    ...
                    <TableHead className="sticky left-[320px] z-10 min-w-[140px] border border-border bg-muted text-muted-foreground">Unit</TableHead>
                    ...
                    <TableHead className="border border-border bg-muted text-muted-foreground">Confirmation</TableHead>
